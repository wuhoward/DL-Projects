...
#### Complex Model
The original StackGAN paper use the complex version of the generator and the discriminator. Nevertheless, in our experiments, we find out that the generated images are unstable, the colors are unnatural, and the shapes are smoother in a strange way. Furthermore, mode collapse happens easily after long enough training. The result is shown below:
